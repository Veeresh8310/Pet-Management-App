...
final class ForgotPasswordSuccessState extends AuthenticatonState{
  String message;
  ForgotPasswordSuccessState({required this.message});
}

final class ForgotPasswordErrorState extends AuthenticatonState{
  String errorMessage;
  ForgotPasswordErrorState({required this.errorMessage});
}

final class ForgotPasswordLoadingState extends AuthenticatonState{
